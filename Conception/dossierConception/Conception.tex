...
\rhead{}
\lhead{\includegraphics[width=1.5cm]{./Picture/logoEseo.eps}}
\cfoot{\thepage}
...
La classe Transmitter est la classe centrale de l'application. Elle permet de rediriger les requêtes reçues vers les différents objets concernés.  

Les classes RACC, BDCC et ZWaveController correspondent respectivement à l'interfaçage avec l'application android, le big data et les objets connectés.
		\newpage
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width = 25cm ,height = 35cm,keepaspectratio]{./Picture/Diagramme_de_class_java_Model.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width = 25cm ,height = 35cm,keepaspectratio]{./Picture/Diagramme_de_classe_java_View.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width = 18cm ,height = 30cm,keepaspectratio]{./Picture/machine_a_etat_java.png}
