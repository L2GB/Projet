...
#define SWITCH_COLOR_CAP_SOFT_WHITE     0x00
#define SWITCH_COLOR_CAP_HARD_WHITE     0x01
#define SWITCH_COLOR_CAP_RED            0x02
#define SWITCH_COLOR_CAP_GREEN          0x03
#define SWITCH_COLOR_CAP_BLUE           0x04
#define SWITCH_COLOR_CAP_AMBER          0x05
#define SWITCH_COLOR_CAP_CYAN           0x06
#define SWITCH_COLOR_CAP_PURPLE         0x07
#define SWITCH_COLOR_CAP_COLOR_INDEX    0x08
...
//
// @param: capabilityId
// Capability Id (one of SWITCH_COLOR_CAP_* constants)
//
// @param: successCallback
// @default: NULL
// Custom function to be called on function success
...
//
// @param: capabilityIds
// Array of capabilities to set (one of SWITCH_COLOR_CAP_* constants)
//
// @param: states
...
//
// @param: capabilityId
// Capability Id (one of SWITCH_COLOR_CAP_* constants) to start changing state for
//
// @param: dir
// Direction of change: 0 to incrase, 1 to decrase
//
...
//
// @param: capabilityId
// Capability Id (one of SWITCH_COLOR_CAP_* constants) to stop changing state for
//
// @param: successCallback
// @default: NULL
// Custom function to be called on function success
